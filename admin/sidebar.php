    ...
    <div class="menu-sidebar2__content js-scrollbar1">
        ...
        <nav class="navbar-sidebar2">
            <ul class="navbar__list">
                ...
                <li class="menu-item <?php echo ($current_page == 'data_pendaftar.php') ? 'active' : ''; ?>">
                    <a href="data_pendaftar.php"><i class="fas fa-users"></i>Data Pendaftar</a>
                </li>
                <li class="menu-item <?php echo ($current_page == 'cetak_laporan.php') ? 'active' : ''; ?>">
                    <a href="cetak_laporan.php"><i class="fas fa-print"></i>Cetak Laporan</a>
                </li>
